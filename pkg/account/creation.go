...
import (
	"github.com/RichCG888/gotron-sdk/pkg/keys"
	"github.com/RichCG888/gotron-sdk/pkg/mnemonic"
...
func CreateNewLocalAccount(candidate *Creation) error {
	...
	private := keys.FromMnemonicSeedAndPassphrase(candidate.Mnemonic, candidate.MnemonicPassphrase, 0)
